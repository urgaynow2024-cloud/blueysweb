...
export const tosSections = [
  ...
  },
  {
    ...
    items: [
      ...
      "All commission payments must be made through a PayPal invoice issued by Bluey Commissions. Do not send payments through alternative payment methods or direct transfers.",
      "The commission is not considered paid until the PayPal invoice has been successfully paid.",
    ...
    highlight_box: "Payments must be made through official PayPal invoices only. Direct transfers or alternative methods are not accepted.",
    box_type: "warning",
    box_title: "PayPal Invoices Only",
  },
  {
    title: "Refund Policy",
    icon: "💸",
