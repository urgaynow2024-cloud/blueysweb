    ...
    <div className="mx-auto max-w-6xl">
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {testimonials.map((t, i) => (
          <Reveal key={t.id} delay={(i % 4) * 50}>
            <div className="group relative h-full overflow-hidden rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--bg-card)] p-8 shadow-lg transition-all duration-500 hover:border-[var(--border-hover)] hover:shadow-2xl hover:shadow-black/50">
