...
export default function ClientReviewForm() {
  ...
  async function handleImageUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const msg = e instanceof UploadError ? e.message : "Upload failed. Please try again.";
      alert(msg);
    } finally {
  ...
  if (submitted) {
    return (
      <div className="relative overflow-hidden rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--bg-card)] p-8 text-center">
        ...
        <div className="absolute -top-20 -right-20 h-[250px] w-[250px] rounded-full bg-[var(--accent-cosmic)] opacity-[0.06] blur-[80px]" />
        <div className="absolute -bottom-16 -left-16 h-[200px] w-[200px] rounded-full bg-[var(--accent-nebula)] opacity-[0.05] blur-[80px]" />
  ...
  return (
    <div className="relative overflow-hidden rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--bg-card)] p-7 md:p-8">
      <div className="pointer-events-none absolute -top-28 -right-28 h-[350px] w-[350px] rounded-full bg-[var(--accent-cosmic)] opacity-[0.05] blur-[100px]" />
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-[300px] w-[300px] rounded-full bg-[var(--accent-nebula)] opacity-[0.04] blur-[100px]" />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[var(--accent)]/4 via-transparent to-[var(--accent-2)]/4" />
      <div className="relative">
