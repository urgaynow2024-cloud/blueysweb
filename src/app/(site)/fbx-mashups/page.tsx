...
import { fbxMashupPortfolio } from "@/data/site";
        ...
        <div className="container">
          ...
          <Reveal>
            <div className="mx-auto max-w-3xl rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--bg-card)]/60 p-8 mb-12">
              <p className="text-lg leading-relaxed text-[var(--text-secondary)]">
                ...
                is performed in Blender and Unity, following VRChat's technical requirements
          ...
          <div className="mb-16">
            ...
            <div className="space-y-8">
              {fbxMashupPortfolio.map((item, i) => (
                <Reveal key={item.id} delay={(i % 4) * 50}>
                  <div className="rounded-[var(--r-lg)] border border-[var(--border)] bg-[var(--bg-card)] overflow-hidden transition-all duration-500 hover:border-[var(--border-hover)]">
                    <div className="grid lg:grid-cols-2 gap-0">
                      ...
                      <div className="p-6">
                        ...
                        <p className="text-sm text-[var(--text-dim)] mb-4">Base: {item.baseAvatar}</p>
